...
## Purpose
Define el contrato del outbox transaccional de koty-app: un almacén append-only en el que los servicios de dominio registran cada evento de dominio dentro de la misma transacción de base de datos que origina la mutación, garantizando atomicidad, idempotencia por clave semántica, inmutabilidad y cero llamadas externas dentro de la transacción de negocio.
