...
## Purpose
Define el contrato HTTP para procesar comandos sensibles con idempotencia en la API de koty-app, garantizando que reintentos con la misma clave y huella canónica devuelvan el resultado original sin repetir efectos, y que reintentos con la misma clave pero contenido distinto sean rechazados explícitamente.
