...
## Purpose
Define el flujo de migraciones reproducibles con Prisma sobre PostgreSQL local, su validación al arrancar y la ejecución de pruebas de integración contra bases aisladas.
