# workspace-build Specification

## Purpose
Define la compilación completa y el desarrollo paralelo de las aplicaciones y paquetes del workspace desde la raíz del repositorio.
## Requirements
